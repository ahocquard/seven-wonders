Feature: Setup the game when the players start a new game

  @todo
  Scenario: A Wonders board and the face to be used during the game are randomly provided to each player
    ...
    And each player has the face of the board to use during the game which is randomly picked also
